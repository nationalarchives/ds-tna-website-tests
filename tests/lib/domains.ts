const getCookieDomainFromBaseUrl: (baseURL: string | undefined) => string = (
  ...
  const cookieDomains = {
    ...
    "https://beta.nationalarchives.gov.uk": ".nationalarchives.gov.uk",
    "https://staging-beta.nationalarchives.gov.uk": ".nationalarchives.gov.uk",
    "https://dev-beta.nationalarchives.gov.uk": ".nationalarchives.gov.uk",
