...
test("all feed - rss", { tag: ["@www"] }, async ({ page }) => {
...
test("all feed - atom", { tag: ["@www"] }, async ({ page }) => {
...
// test("digital blog feed - rss", {tag: ["@www"]}, async ({ page }) => {
...
// test("digital blog feed - atom", {tag: ["@www"]}, async ({ page }) => {
...
test("non-existant feed", { tag: ["@www"] }, async ({ page }) => {
